;;; better-tango-dark-theme.el --- Tango-based custom theme for faces

;; Copyright (C) 2010-2011 Free Software Foundation, Inc.

;; Original Authors: Chong Yidong <cyd@stupidchicken>
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(cursor ((,class (:foreground ,alum-6 :background ,alum-6))))
   ;; Highlighting faces
   ...
   ;; Dired faces
   `(dired-face-boring ((,class (:foreground ,alum-1))))
	 `(dired-face-directory ((,class (:foreground ,alum-1))))
	 `(dired-face-executable ((,class (:foreground ,alum-1))))
	 `(dired-face-flagged ((,class (:foreground ,alum-1))))
	 `(dired-face-marked ((,class (:foreground ,alum-1))))
	 `(dired-face-permissions ((,class (:foreground ,alum-1))))
	 `(dired-face-setuid ((,class (:foreground ,alum-1))))
	 `(dired-face-socket ((,class (:foreground ,alum-1))))
	 `(dired-face-symlink ((,class (:foreground ,alum-1))))
	 `(diredp-display-msg ((,class (:foreground ,alum-1))))
	 `(diredp-dir-heading ((,class (:background ,orange-1))))
	 `(diredp-deletion ((,class (:foreground ,alum-1))))
	 `(diredp-deletion-file-name ((,class (:foreground ,alum-1))))
	 `(diredp-flag-mark ((,class (:foreground ,alum-1))))
	 `(diredp-flag-mark-line ((,class (:foreground ,alum-1))))
	 `(diredp-file-suffix ((,class (:foreground ,cham-0))))
	 `(diredp-symlink ((,class (:foreground ,alum-1))))
	 `(diredp-date-time ((,class (:foreground ,alum-1))))
	 `(diredp-file-name ((,class (:foreground ,cham-0))))
	 `(diredp-ignored-file-name ((,class (:foreground ,alum-1))))
	 `(diredp-compressed-file-suffix ((,class (:foreground ,alum-1))))
	 `(diredp-executable-tag ((,class (:foreground ,alum-1))))
	 `(diredp-dir-priv ((,class (:foreground ,alum-1))))
	 `(diredp-exec-priv ((,class (:foreground ,alum-1))))
	 `(diredp-other-priv ((,class (:foreground ,alum-1))))
	 `(diredp-write-priv ((,class (:foreground ,alum-1))))
	 `(diredp-read-priv ((,class (:foreground ,alum-1))))
	 `(diredp-no-priv ((,class (:foreground ,alum-1))))
	 `(diredp-rare-priv ((,class (:foreground ,alum-1))))
	 `(diredp-link-priv ((,class (:foreground ,alum-1)))))
...
(provide-theme 'better-tango-dark)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; better-tango-dark-theme.el ends here
